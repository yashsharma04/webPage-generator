<div class='main'>
  <div class='container'>
    <input class='search' type='text' id= 'search_title' name ='search' placeholder='Search By Title'/>
    <input class ='search' type='text' id= 'search_date' name ='search' placeholder='dd/mm/yy'/>
  </div>
</div>
